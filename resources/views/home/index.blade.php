  ...
  {{-- <div class="services mt-5 bg-light py-5">
    <div class="container">
      ...
      <p class="text-center mt-4">
        Untuk memenuhi kebutuhan nasabah yang beragam, BPR Mitra Pandanaran Mandiri melengkapi 
        layanannya dengan berbagai produk. Tujuannya adalah agar semua kebutuhan nasabah dapat 
        dilayani dengan baikz
      </p>
      <div class="row mt-5">
  ...
  <div class="portfolio-us mt-5">
    <div class="container">
      <div class="title-container">
        <h2 class="text-center fw-bold">REPORT</h2>
      </div>
      <div class="row mt-4">
