        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li><a class="dropdown-item" href="testimonials">Carier</a>
...
<!-- visi misi -->
  ...
  <div class="title-container ">
        <h2 class="text-center fw-bold ">Visi dan Misi BPR Mitra Pandanaran Mandiri</h2>
      </div>
       <p class="text-center ">
        <h4 class="fw-bold " >Visi</h2>
          <p class=" ">
Menjadi BPR yang terpercaya dan profesional  yang menjadi Mitra Usaha Nasabah yang saling menguntungkan</p>
        <h4 class="fw-bold " >Misi</h2>
<p class="">
Memberikan Pelayanan Prima pada nasabah dengan menyediakan produk dan jasa keuangan sesuai keperluan nasabah</p>
<p class="">
Memberikan pelayanan Jasa keuangan mikro kepada nasabah sebagai lembaga intermediasi dalam meningkatkan taraf hidup masyarakat</p>
      </p>
  ...
  <div class="teams bg-light mt-5 py-5">
    <div class="container">
      <div class="title-container ">
        <h2 class="text-center fw-bold ">Jajaran Komisaris dan Direksi</h2>
      </div>
    ...
    <div class="footer-top bg-dark text-white p-5 ">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-3">
            <h4 class="fw-bold">newsletter</h2>
              <p>
                Kami akan memberi informasi ke pada anda tentang produk terbaru kami.
              </p>
