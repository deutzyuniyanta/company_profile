  ...
  <title>PT. BPR Mitra Pandanaran Mandiri</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow shadow-sm fixed-top fy-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                <a class="nav-link fw-bolder active" href="services">Product</a>
            </li>
            <li class="nav-item">
    ...
    <div class="services bg-light py-5">
        <div class="container">
            ...
            <p class="text-center mt-4">Untuk memenuhi kebutuhan nasabah yang beragam, BPR Mitra Pandanaran Mandiri 
                melengkapi layanannya dengan berbagai produk. Tujuannya adalah agar semua kebutuhan nasabah 
                dapat dilayani dengan baik</p>
            <div class="row mt-5">
                ...
                <div class="card border-0 text-center p-4 mt-3" data-aos="zoom-in">
                    <div class="card-body">
                    <div class="card-icon">
                        <img src="image/{{$service->image}}" alt="" class="img-fluid" width="375">
                    </div>
