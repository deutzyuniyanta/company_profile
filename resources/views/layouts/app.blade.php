...
<head>
  ...
  <title>@yield('BPR Mitra Pandanaran Mandiri')</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admin/dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">BPR Mitra Pandanaran Mandiri</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{ date('Y') }} <a href="https://xxxxxx">PT. BPR Mitra Pandanaran Mandiri</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
